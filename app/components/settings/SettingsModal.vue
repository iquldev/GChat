<template>
  ...
  >
    ...
    >
      <div
        v-if="isAnimating"
        class="bg-(--ui-block-background) flex md:flex-row flex-col w-[min(900px,95vw)] md:h-[600px] h-[80vh] rounded-4xl border border-default overflow-hidden shadow-2xl"
      >
        <!-- Sidebar -->
        <aside
        ...
        <!-- Main Content -->
        <main class="flex-1 flex flex-col min-w-0 bg-(--ui-block-background)">
          <div
              ...
              <div :key="activeCategory" class="flex flex-col gap-4">
                ...
                <template v-if="activeCategory === 'ai'">
                  ...
                  <SettingsSetting
                    ...
                    type="text"
                    :placeholder="$t('settings.placeholders.customModelId')"
                  />
                  <SettingsSetting
                    v-model="userApiKey"
                ...
                <!-- Interface Category -->
                <template v-else-if="activeCategory === 'interface'">
                  <SettingsSetting
                ...
                <template v-else-if="activeCategory === 'data'">
                  ...
                  >
                    <p class="text-sm text-(--ui-text-second)">
...
const categories = computed(() => [
  ...
  { id: 'data', label: t('settings.categories.data'), icon: 'lucide:database' },
]);
