<template>
  <div class="absolute inset-0 overflow-hidden pointer-events-none -z-10 flex items-center justify-center">
    <div
      class="relative w-full max-w-[1000px] h-[500px] opacity-20 dark:opacity-30 transition-opacity duration-500"
    >
      <div
...
<style scoped>
.animate-blob {
  /* Animation is defined in main.css, but we can override or add local tweaks if needed */
}
</style>
